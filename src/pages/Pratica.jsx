        ...
        <div className='flex justify-center items-center gap-5 h-full flex-wrap'>
            <div className='flex flex-col items-center w-56 h-72 rounded-t-[2em] rounded-b-[10em] bg-gradient-to-br from-green-400 to-green-800 border-b-8 border-neutral-300 drop-shadow-lg cursor-pointer hover:scale-110 transition-all duration-300'>
                <div className="flex flex-col justify-center items-center">
                    ...
                    <p className='mt-4 text-center text-sm'>Durante o período, fui encarregado de desenvolver e dar manutenção a features de sitemas Logisticos, assim como a prospecção das mesmas</p>
            ...
            <div className="flex flex-col justify-center items-center">
                    ...
                    <p className='mt-4 text-center text-sm'>Durante o período, fui encarregado de desenvolver e dar manutenção a features de sitemas Logisticos, e também de atender e dar suporte ao cliente final</p>
